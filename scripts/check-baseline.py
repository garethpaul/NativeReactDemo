...
def module_registration_scanner_errors(app_delegate: str, tests: str) -> list[str]:
    ...
    required_source = [
        ...
        "isJavaScriptLineTerminator:",
        "character == 0x2028 || character == 0x2029",
        "containsLineTerminatorFromIndex:",
        "[self javaScriptContents:bundleContents",
        '[identifier isEqualToString:@"break"]',
        '[identifier isEqualToString:@"continue"]',
        '[identifier isEqualToString:@"debugger"]',
    ...
    required_tests = [
        ...
        "label comment\\n*/ /AppRegistry.registerComponent('WowNativeReact',.*)/",
        "debugger\\n/AppRegistry.registerComponent('WowNativeReact',.*)/",
        "continue outer\\u2028/AppRegistry.registerComponent('WowNativeReact',.*)/",
        "break outer\\u2029/AppRegistry.registerComponent('WowNativeReact',.*)/",

...
- `make build`
- `make check`
- hostile mutations removing the size limit, metadata guard, or pre-read
  ordering were each rejected by the static contract
- `git diff --check`
...
`d116a38df9e34209458ebd4f1f874a91955cb376`:

- push run `27397502614`: success
- pull-request run `27397504019`: success
